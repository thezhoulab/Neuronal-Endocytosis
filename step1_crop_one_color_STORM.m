%% This file is used to crop regions for one-color STORM analysis
clear all;
close all;
clc;
binpath = '\\E1-054867\Jinyu\20250330 Actin in neuron\Analysis\#3 LatB'; %%%%%%% path that you saved your png and bin files
